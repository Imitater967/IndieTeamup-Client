...
class InvestorManagerIdentity extends StatefulWidget {
  @override
...
class _WorkerIdentityState extends State<InvestorManagerIdentity> {
  @override
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(onPressed: (){
              Navigator.pushNamed(context, "/welcome/investorCompanyIdentity");
            }, child: Text("下一步"),style: Constants.mainButtonStyleB,)
          ],
        ),
      ),
    ));
